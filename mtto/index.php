...
<html lang="es">
  <head>
    ...
    <script>
      ...
      function muestraFormulario(event)
      {
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item ">
              <a class="nav-link" href="#" id="inicio" data-toggle="modal" data-target="#exampleModal" > Iniciar sesión </a>
          </li>
          <li class="nav-item">
