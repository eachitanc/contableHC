...
.Estilo18 {font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;}
...
<table width="800" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    <td><div class="Estilo18" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> 1. Descargue la plantilla de MS Excel &copy; presionando el boton izquierdo de su raton ...::: <a href="plantilla/CBVA.xls"><strong>AQUI</strong></a> :::... </div></td>
  </tr>
  <tr>
    <td><div class="Estilo18" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> 2. Diligencie la plantilla siguiendo las instrucciones que se encuentran en los comentarios de la hoja activa </div></td>
  </tr>
  <tr>
    <td><div class="Estilo18" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> 3. Suba el archivo usando el siguiente cuadro: </div></td>
  </tr>
  <tr>
    <td><form action="subesico.php" method="post" enctype="multipart/form-data">
      <div align="center">
  ...
  <tr>
    <td><div class="Estilo18" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> 4. Verifique los datos cargados a continuacion:</div></td>
  </tr>
  <tr>
    <td><div class="Estilo18" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
while($rw = @mysql_fetch_array($re)) 
   {
		...
		,$rw["fecha"],$rw["dcto"],$rw["cuenta"],$rw["nombre"],$rw["cheque"],$rw["tercero"]
		,number_format($rw["debito"],2,',','.'),number_format($rw["credito"],2,',','.'));
