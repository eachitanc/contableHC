...
<?php
   ...
   $connection = mysql_connect($server, $dbuser, $dbpass) or die ("Fallo en la Conexion a la Base de Datos");
	...
	$sx = "select tip_dato from car_ppto_ing where id_emp='$idxx' AND cod_pptal ='$cod_pptal'";
...
$sSQL="Update car_ppto_ing Set 	nom_rubro='$nombre', proc_rec='$proc_rec', situacion='$situacion',vigencia ='$vigencia'
