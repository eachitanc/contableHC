...
if (saldo_actual < valor_actual)
	{
	alert("El valor a reducir es mayor al saldo del rubro más el valor actualmente contracreditado");
...
// consulto la tabla contracredito de acuerdo a los parametros recibidos de modificar
  ...
  <input name="nom_rubro" type="hidden" id="id_emp" value="<?php printf($r[nom_rubro]); ?>"/>
      ...
      <tr>
        ...
        <td width="143"><div id="div6" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
            <div align="center"> <span class="Estilo4"><strong>Presupuesto Inicial</strong><br /><div id="resp2">
                  <?php //printf("%.2f",$ppto_aprob); ?></div>
              </span>
                <br />
            </div>
        </div></td>
        <td width="154"><div id="div13" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
