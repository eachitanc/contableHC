...
.Estilo11 {font-size: 10px; font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;}
-->
</style>
</head>
...
<br />
		...
		<table width="880" border="1" align="center" class="bordepunteado1">
		  <tr>
            <td bgcolor="#DCE9E5" width="100"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                <div align="center" class="Estilo4">
		    ...
		    <td bgcolor="#DCE9E5" width="150"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                <div align="center" class="Estilo4">
