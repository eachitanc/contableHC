...
while($rw = mysql_fetch_array($re)) 
   {
		...
		$nom_rubro = ereg_replace("[,;]", "",$nombrer);
		if ($tip_dato == 'M')
		{
			printf("
			<span class='Estilo4'>
...
// ************************************************ CGR ***********************************************************
 ...
 //  Codigo del recurso
	...
	// Campo cds
			...
			$re24 = mysql_query($sq24, $connection) or die(mysql_error());
			if ((mysql_num_rows($re24) == 0))
			{			
	...
	// Vigencia del gasto
			...
			$re25 = mysql_query($sq25, $connection) or die(mysql_error());
			if ((mysql_num_rows($re25) == 0))
			{			
	...
	// finalidad del gasto
			...
			$re27 = mysql_query($sq27, $connection) or die(mysql_error());
			if ((mysql_num_rows($re27) == 0))
			{			
