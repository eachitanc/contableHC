...
while($rw = mysql_fetch_array($re))
{
	...
	$total = $ejecutado + $resago;
			...
			<td align='right'>%s</td>
			<td align='right'>%s</td>
			</tr>", $rw["cod_pptal"], ucfirst(ereg_replace("[,;]", "",$rw["nom_rubro"])),$definitivo,$rw6["enero"],$rw7["febrero"],$rw8["marzo"],$rw9["abril"],$rw10["mayo"],$rw11["junio"],$rw12["julio"],$rw13["agosto"],$rw14["septiembre"],$rw15["octubre"],$rw16["noviembre"],$rw17["diciembre"],$resago,$total); 
			}
printf("</table></center>");
}
?>