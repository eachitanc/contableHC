...
if ($mes_a <> $mes_s )
{
 	?>
	<script> 
	alert ("La fecha de sesión no coincide con la fecha del registro a eliminar... Primero cambie la fecha de sesión");
	history.back(1)
	</script>
	<?
}
...
$rr = mysql_db_query($database, $sql, $connectionxx);
