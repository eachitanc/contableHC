...
//-------
 ...
 <BR /><BR /><div align="center" class="Estilo4"><strong>APLAZAMIENTOS LEVANTADOS HASTA LA FECHA</strong> </div><BR />
						...
						$re2 = mysql_db_query($database, $sq2, $cx);
							...
							while ($rw2 = mysql_fetch_array ($re2))
							{
								...
								<tr class="Estilo4">
									...
									<td align="right">
										<? printf(number_format($valor_lev,2,",","."));?>
									</td>
									<td>
										<img src="../simbolos/modificarblanco.png" width="16px" border="0" alt="Eliminar"/>
									</td>
