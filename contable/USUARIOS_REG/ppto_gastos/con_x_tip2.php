...
if ($a=='CDPP') $tipo ='CERTIFICADO DE DISPONIBILIDAD PRESUPUESTAL';
if ($a=='CRPP') $tipo ='REGISTRO PRESUPUESTAL';
if ($a=='COBP') $tipo ='OBLIGACION PRESUPUESTAL';
?>
...
<tr>
	<td align="center" colspan="5"><font size="4"><b><?php echo $empresa; ?></b></font></td>
</tr>
<tr>
    <td align="center" colspan="5"><font size="4"><b>CONSULTA POR TIPO DE DOCUMENTO FUENTE</b></font></td>
</tr>
<tr>
    <td align="center" colspan="5"><font size="4"><b><?php echo $tipo; ?></b></font></td>
</tr>
<tr>
...
</tr>", CDPP.$rw["cdpp"], $rw["fecha_reg"], $rw["cuenta"], $rw["nom_rubro"], $rw["des"], number_format($rw["valor"],2,'.',',')); 
$val=$val+$rw["valor"];
...
$tercero =  $rw["tercero"];
		...
		$resultadoxx2a = mysql_db_query($database, $sqlxx2a, $cx);
...
</tr>", $rw["id_manu_crpp"], $rw["fecha_crpp"], $rw["cuenta"], $nom_rubro, $tercero, $rw["detalle_crpp"], number_format($rw["vr_digitado"],2,'.',',')); 
...
</tr>", $rw["id_manu_cobp"], $rw["fecha_cobp"], $rw["cuenta"], $rw["nom_rubro"], $tercero, $rw["des_cobp"], number_format($rw["vr_digitado"],2,'.',',')); 
$val=$val+$rw["vr_digitado"];
