...
// Consulto AÑO de la vigencia actual
...
while($rw = mysql_fetch_array($re))
{
	...
	$diciembre = $rw17["diciembre"] + $rw2["adicion"] - $rw3["reduccion"] + $rw4["credito"] - $rw5["contracredito"];
			...
			<td align='right'>%s</td>
			<td align='right'>%s</td>
			</tr>", $rw["cod_pptal"], ucfirst(ereg_replace("[,;]", "",$rw["nom_rubro"])), $definitivo,(int)$rw6["enero"],(int)$rw7["febrero"],(int)$rw8["marzo"],(int)$rw9["abril"],(int)$rw10["mayo"],(int)$rw11["junio"],(int)$rw12["julio"],(int)$rw13["agosto"],(int)$rw14["septiembre"],(int)$rw15["octubre"],(int)$rw16["noviembre"],(int)$diciembre,$resago,$total); 
			}
printf("</table></center>");
}
?>