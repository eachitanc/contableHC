...
.Estilo23 {font-size: 10px; font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;}
-->
</style>
</head>
...
<? 
		   ...
		   $a=$_POST['nn'];  
		   $a1x=$_POST['nn'];  
		   $a1=mysql_query("select * from pac_gastos where cod_pptal = '$a' and id_emp ='$idxx'");  
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_ene); 
				?> 
				<input name="pac_uti_ene" type="hidden" id="pac_uti_ene" value="<? printf('%.2f',$acum_ene); ?>"/>
				</div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_ene=$pac_def_ene-$acum_ene; printf('%.2f',$sal_pac_ene); ?>
                </div>
              </div>
            </div></td>
          </tr>
...
<input name="adi_pac_feb" type="text" class="Estilo4" id="adi_pac_feb" style="text-align:right" value="<? printf('%.2f',$adi_pac_feb); ?>" size="20" maxlength="20"/>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_feb); 
				?>
                  <input name="pac_uti_feb" type="hidden" id="pac_uti_feb" value="<? printf('%.2f',$acum_feb); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right"><? $sal_pac_feb=$pac_def_feb-$acum_feb; printf('%.2f',$sal_pac_feb); ?> </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_mar); 
				?>
                  <input name="pac_uti_mar" type="hidden" id="pac_uti_mar" value="<? printf('%.2f',$acum_mar); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right"><? $sal_pac_mar=$pac_def_mar-$acum_mar; printf('%.2f',$sal_pac_mar); ?></div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_abr); 
				?>
                  <input name="pac_uti_abr" type="hidden" id="pac_uti_abr" value="<? printf('%.2f',$acum_abr); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_abr=$pac_def_abr-$acum_abr; printf('%.2f',$sal_pac_abr); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_may); 
				?>
                  <input name="pac_uti_may" type="hidden" id="pac_uti_may" value="<? printf('%.2f',$acum_may); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_may=$pac_def_may-$acum_may; printf('%.2f',$sal_pac_may); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_jun); 
				?>
                  <input name="pac_uti_jun" type="hidden" id="pac_uti_jun" value="<? printf('%.2f',$acum_jun); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_jun=$pac_def_jun-$acum_jun; printf('%.2f',$sal_pac_jun); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_jul); 
				?>
                  <input name="pac_uti_jul" type="hidden" id="pac_uti_jul" value="<? printf('%.2f',$acum_jul); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_jul=$pac_def_jul-$acum_jul; printf('%.2f',$sal_pac_jul); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_ago); 
				?>
                  <input name="pac_uti_ago" type="hidden" id="pac_uti_ago" value="<? printf('%.2f',$acum_ago); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_ago=$pac_def_ago-$acum_ago; printf('%.2f',$sal_pac_ago); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_sep); 
				?>
                  <input name="pac_uti_sep" type="hidden" id="pac_uti_sep" value="<? printf('%.2f',$acum_sep); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_sep=$pac_def_sep-$acum_sep; printf('%.2f',$sal_pac_sep); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_oct); 
				?>
                  <input name="pac_uti_oct" type="hidden" id="pac_uti_oct" value="<? printf('%.2f',$acum_oct); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_oct=$pac_def_oct-$acum_oct; printf('%.2f',$sal_pac_oct); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_nov); 
				?>
                  <input name="pac_uti_nov" type="hidden" id="pac_uti_nov" value="<? printf('%.2f',$acum_nov); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_nov=$pac_def_nov-$acum_nov; printf('%.2f',$sal_pac_nov); ?>
                </div>
              </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
				...
				printf('%.2f',$acum_dic); 
				?>
                  <input name="pac_uti_dic" type="hidden" id="pac_uti_dic" value="<? printf('%.2f',$acum_dic); ?>"/>
                </div>
              </div>
            </div></td>
            <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">
                  <? $sal_pac_dic=$pac_def_dic-$acum_dic; printf('%.2f',$sal_pac_dic); ?>
                </div>
              </div>
            </div></td>
          </tr>
