...
?>
  ...
  <input name="nom_rubro" type="hidden" id="id_emp" value="<?php printf($r[nom_rubro]); ?>"/>
      ...
      <tr>
        ...
        <td width="144"><div id="div6" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        ...
        <td width="153"><div id="div13" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        ...
        <td>&nbsp;</td>
         <td width="144"><div id="div6" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
            <div align="center"> <span class="Estilo4"><strong>Total Aplazamientos</strong><br />
               <font color="#0000FF"><div id="resp3"></div></font>
              </span>
                           <br />
            </div>
        </div></td>
        <td><div id="div15" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center"> 
		  <span class="Estilo4">
		  <strong>Disponible para Aplazar </strong>
		  <br /><font color="#FF0000">
		 <div id="saldo"></div> </font>          </span>
