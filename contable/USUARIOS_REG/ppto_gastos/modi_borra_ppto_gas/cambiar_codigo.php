      ...
      <tr>
		...
		<div id="div7" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
          	  <div align="center"><strong>MODIFICAR CUENTA DEL PRESUPUESTO DE GASTOS </strong><br />
          	    <br />
          	    <strong>Descripcion</strong>: Este proceso consiste en CAMBIAR una cuenta  DETALLE a MAYOR, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga  del Presupuesto de Gastos.          	  </strong></div>
		</div></td>
        </tr>
      <tr>
        <td colspan="2" class="Estilo4"><div id="div5" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
          ...
          <span class="Estilo8">VERIFIQUE LA FECHA EN LA QUE REALIZARA ESTE CAMBIO </span></div>
        </div></td>
        </tr>
      <tr>
...
$strSQL = "SELECT * FROM car_ppto_gas WHERE id_emp = '$idxx' AND tip_dato = 'D' AND afectado = '0' 
...
?>
  ...
  <tr>
	...
	<div align="center">
	<a href="../consulta_ppto_gas.php" target="_parent">VOLVER</a>	</div>
	</div>
	</div>	</td>
    <td>&nbsp;</td>
  </tr>
