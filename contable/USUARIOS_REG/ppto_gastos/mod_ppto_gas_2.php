  ...
  <input name="id" type="hidden" value="<?php printf($editar); ?>"/>
      ...
      <tr>
        ...
        <td width="152" ><div id="div6" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
            <div align="center" > <span class="Estilo4"><strong>Presupuesto Inicial Aprobado</strong><br /><div id="resp">
                  <?php  //echo number_format($ppto_aprob,2,",","."); ?> </div> 
              </span>
        ...
        <td width="145"><div id="div13" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center"> <span class="Estilo4"><strong>Presupuesto Definitivo hasta la Fecha </strong><br /><div id="resp2">
                <?php  //echo number_format($definitivo,2,",","."); ?></div>
            </span><br />
          </div>
        </div></td>
      </tr>
