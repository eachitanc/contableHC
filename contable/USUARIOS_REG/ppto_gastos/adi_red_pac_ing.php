...
while($rowxx = mysql_fetch_array($resultadoxx)) 
   ...
   $idxx=$rowxx["id_emp"];
	...
	<form name="empresa" method="post" action="adi_red_pac_ing_2.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
      ...
      <tr>
        <td colspan="2" class="Estilo4"><div id="div6" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
            <div align="center">
...
?>
  ...
  <tr>
    <td colspan="3"><div id="div2" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
