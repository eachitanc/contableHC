...
<? 
		   ...
		   $a=$_GET['id'];  
		   $a1=mysql_query("select * from car_ppto_gas where cod_pptal = '$cod_pptal' and id_emp ='$idxx'");  
...
<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td width="726" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center"><strong>FORMATO UNICO TERRITORIAL DE GASTOS <br />
            - F.U.T - </strong></div>
        </div></td>
      </tr>
      <tr>
        <td class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
<? 
 ...
 ?>
      ...
      <tr>
        <td bgcolor="#F5F5F5" class="Estilo4"><div style="padding-left:20px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="left">
      ...
      <tr>
        <td bgcolor="#FFFFFF" class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
					  <?php //printf("%s", $cc); ?>
		<? if ($cc == 'ANTERIOR')
			{	
		?>
