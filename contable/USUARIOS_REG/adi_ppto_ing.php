		...
		<?php
				...
				while ($rw = mysql_fetch_array ($re))
				{
					...
					$concepto_adi = $rw["concepto_adi"];  
						...
						$sq2 = "select * from adi_ppto_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
						$re2 = mysql_db_query($database, $sq2, $cx);
					
							while ($rw2 = mysql_fetch_array ($re2))
							{
									$sq4 ="select nom_rubro from car_ppto_ing where cod_pptal = '$rw2[2]'";
									$re4 = mysql_db_query($database, $sq4, $cx);
									$rw4 = mysql_fetch_array ($re4);
									$id = $rw2[0];
									$cod_pptal = $rw2[2];
									$nom_rubro = ucfirst(ereg_replace("[,;%]", "",$rw4['nom_rubro']));
									$fecha_adi = $rw2[4];
									$valor_adi = $rw2[8]; 
							...
							$sq3 = "select sum(valor_adi) as valor from adi_ppto_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
