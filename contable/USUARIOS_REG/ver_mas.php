...
<table width="800" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
	...
	$resulta=mysql_query("select SUM(valor_adi) AS TOTAL from adi_ppto_ing 
	...
	<?
	$link=mysql_connect($server,$dbuser,$dbpass);
	$resulta2=mysql_query("select SUM(valor_adi) AS TOTAL from red_ppto_ing 
	WHERE (fecha_adi between '$fecha_ini' and '$fecha_fin' ) and id_emp='$idxx' and cod_pptal ='$cuenta'",$link) or die (mysql_error());
  ...
  <tr>
    <td colspan="4" bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
      <div align="center">PRESUPUESTO DEFINITIVO :  <? $ppto_def = $definitivo+$total_adi-$total_red; echo "$".number_format($ppto_def,2,',','.')."=";  ?></div>
    </div></td>
  </tr>
  ...
  <tr>
    ...
    <td><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">
        <?
	$link=mysql_connect($server,$dbuser,$dbpass);
	$resulta3=mysql_query("select SUM(valor) AS TOTAL from reip_ing 
    ...
    <td><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">
        <?
	$link=mysql_connect($server,$dbuser,$dbpass);
	$resulta4=mysql_query("select SUM(vr_digitado) AS TOTAL from recaudo_roit 
  ...
  <tr>
    <td bgcolor="#00CCCC"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">TOTAL ING. RECONOCIDOS  : </div>
    </div></td>
    <td bgcolor="#00CCCC"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">
        <?
...
$suma2=$total_roit+$otros_rec;
  ...
  <tr>
    ...
    <td bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
        <div align="center" class="Estilo5">
          <div align="right">
            <? $tx9=$ppto_def-$total_reip-$otros_rec; echo number_format($tx9,2,',','.');?>
            </div>
        </div>
    </div></td>
  ...
  <tr>
    ...
    <td bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center" class="Estilo5">
        <div align="right">
          <? $tx9a=$total_reip+$otros_rec; echo number_format($tx9a,2,',','.');?>
          </div>
      </div>
    </div></td>
    <td bgcolor="#DCE9E5"></td>
  ...
  <tr>
    ...
    <td bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center" class="Estilo5">
        <div align="right">
          <? $tx9aA=$total_roit+$otros_rec; echo number_format($tx9aA,2,',','.');?>
          </div>
      </div>
    </div></td>
    <td bgcolor="#DCE9E5"></td>
    ...
    <td bgcolor="#DCE9E5">
        <div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
          <div align="center" class="Estilo4">
            <div align="right">
              <? $tx10=$total_reip-$total_roit; echo number_format($tx10,2,',','.');?>
              </div>
      </div>
    </div></td>
    <td bgcolor="#DCE9E5"></td>
