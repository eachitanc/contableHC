...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
      ...
      <a href="../mvto_contable/menu_cont.php" target="_parent">...::: IR A CONTABILIDAD :::...</a></div>
</div>
<BR />
...
$a = "select distinct(consecutivo) , fecha_reg, tercero, id_manu_reip, consecutivo from reip_ing where id_emp = '$idxx' and contab ='NO' and liq1=''";
	...
	if ($fecha2 == "AÑO"){$f= "and fecha_reg between '$a1' and '$a2'";}
...
?>
	<tr>
		...
		<td align='right' style="Padding-right:10px">
			...
			<?php 
			$resulta2=mysql_query("select SUM(valor) AS TOTAL from reip_ing WHERE consecutivo = '$concec'",$cx) or die (mysql_error());
...
?>
	<tr>
		...
		<td align='right' style="Padding-right:10px">
			...
			<?php 
			$resulta2=mysql_query("select SUM(valor) AS TOTAL from reip_ing WHERE consecutivo = '$concec2' ",$cx) or die (mysql_error());
			$row2=mysql_fetch_row($resulta2);
			$total2=$row2[0]; 
			print(number_format($total2, 2, ",", "."));
