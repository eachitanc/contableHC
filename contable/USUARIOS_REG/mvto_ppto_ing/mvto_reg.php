...
<table width="800" border="0" align="center">
  ...
  <tr>
   ...
   <table width="800" height="186" border="1" align="center" class="bordepunteado1">
        <tr>
          <td height="101" colspan="3"><table border="0" align="center">
            <tr>
...
$resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'reip_ing'");
...
<input name="id_manu_reip" type="text" class="required Estilo4" id="id_manu_reip" size="20" onkeypress="return validar(event)" style="text-align:center" onkeyup="chk_reip();" />
 ...
 <br />
		...
		<div class="Estilo4" align="center" id='res_reip'></div>
          ...
          <div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
		    <div align="center"><span class="Estilo4"><strong>Numero :</strong> <span class="Estilo8">:::</span> <? printf("%s",$consecutivo);?></span> 
		      <input name="consecutivo" type="hidden" class="Estilo4" id="consecutivo" value="<? printf("%s",$consecutivo);?>"/>
		      </div>
          </div>		  </td>
        </tr>
...
?>
<? $fecha_reg = $ano; //printf("%s",$fecha_reg);?>

<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
<div align="center"><span class="Estilo4"><strong>Fecha</strong></span><br />
<br />           
<input name="fecha_reg" type="text" class="Estilo4" id="fecha_reg" value="<? printf("%s",$fecha_reg);?>" size="12" />
<br /><br />
<input name="button2" type="button" class="Estilo4" onclick="displayCalendar(document.a.fecha_reg,'yyyy/mm/dd',this)" value="Seleccione Fecha" />			
        ...
        </tr><tr><td height="5"></td><td width="148"></td>
        <td width="246"></td>
        <td></td></tr>
      </table>
    ...
    <table width="800" border="1" align="center" class="bordepunteado1">
        ...
        <tr>
          <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
              <div align="center">
                <select name="cuenta" class="Estilo4" id="cuenta" style="width: 400px;" onblur="tipo_cuenta();">
				<option value="" ></option>
                  <?
include('config.php');
$db = mysql_connect($server, $dbuser, $dbpass);
