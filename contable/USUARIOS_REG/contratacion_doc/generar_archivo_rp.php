...
while ($rw4 = mysql_fetch_array($res))
{
		...
		$cuentas .=  'al código presupuestal No '. $rw4['cuenta'] .' - '. $nombre . ' por valor de '. number_format($rw4['vr_digitado'],2,',','.') . ', '; 
}
...
//$fec_larga = strftime("%d días del mes de %B de %Y",strtotime("$fec_firma"));
...
$fec_larga = strftime("(%d) días del mes de %B de %Y",strtotime("$fecha_pago"));
$num_rp = $row3['id'];
// datos del cobp
