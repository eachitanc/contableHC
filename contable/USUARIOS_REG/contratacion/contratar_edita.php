    ...
    <td colspan="2">
		...
		<? 
			...
			echo	"
						...
						<option value='CMF6'>CONCURSO DE MÉRITOS - ABIERTO</option>
						<option value='CMF7'>CONCURSO DE MÉRITOS - CON PRECLASIFICACION</option>
						<option value='LPF5'>LICITACIÓN PUBLICA </option> 
						<option value='OPF8'>MINIMA CUANTIA</option>
						<option value='SAF1' selected>SELECCIÓN ABREVIADA </option> 
		...
		<option value='LPF5'>LICITACIÓN PUBLICA </option> 
		<option value='OPF8'>MINIMA CUANTIA</option>
        <option value='SAF1'>SELECCIÓN ABREVIADA</option> 
		...
		<option value='CDF4'>CONTRATACION DIRECTA</option>
   		<option value='CMF6'>CONCURSO DE MÉRITOS - ABIERTO</option>
		<option value='CMF7'>CONCURSO DE MÉRITOS - CON PRECLASIFICACION</option>
		<option value='LPF5' selected>LICITACIÓN PUBLICA </option> 
		<option value='OPF8'>MINIMA CUANTIA</option>
        <option value='SAF1'>SELECCIÓN ABREVIADA</option> 
			...
			echo    "
		<option value='CDF4'>CONTRATACION DIRECTA</option>
   		<option value='CMF6' selected>CONCURSO DE MÉRITOS - ABIERTO</option>
		<option value='CMF7'>CONCURSO DE MÉRITOS - CON PRECLASIFICACION</option>
		<option value='LPF5'>LICITACIÓN PUBLICA </option> 
		<option value='OPF8'>MINIMA CUANTIA</option>
        <option value='SAF1'>SELECCIÓN ABREVIADA</option> 
		...
		<option value='CDF4'>CONTRATACION DIRECTA</option>
   		<option value='CMF6'>CONCURSO DE MÉRITOS - ABIERTO</option>
		<option value='CMF7' selected>CONCURSO DE MÉRITOS - CON PRECLASIFICACION</option>
		<option value='LPF5'>LICITACIÓN PUBLICA </option> 
		<option value='OPF8'>MINIMA CUANTIA</option>
        <option value='SAF1'>SELECCIÓN ABREVIADA </option> 
...
<tr>
 ...
 <tr>
    <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
	      <div align="center" class="Estilo4">
    	    <div align="right"><strong>FECHA TERMINACIÓN : </strong></div>
     	 </div>
    	</div>	</td>
    <td colspan="2"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
    	  <div align="center" class="Estilo4">
...
<tr>
	...
	<td colspan="2">
        ...
        <div align="left">
			...
			<? //Busco todos los terceros en las tablas naturales y juridicos donde el campór interventor este marcado y los unifico en un solo row
