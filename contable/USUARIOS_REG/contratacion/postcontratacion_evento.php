...
<tr  style="display:<? echo ($ver_garantias); ?> ">	
	...
	<td  class="Estilo4" colspan="3">
			...
			<option value="AS6">CONDOR S.A. COMPAÑÍA DE SEGUROS GENERALES</option>
			<option value="AS7">COMPAÑÍA MUNDIAL DE SEGUROS S.A</option>
			<option value="AS8">SEGUROS GENERALES SURAMERICANA S.A.</option>
			<option value="AS9">CHUBB DE COLOMBIA COMPAÑÍA DE SEGUROS S.A.</option>
			<option value="AS10">GENERALI COLOMBIA SEGUROS GENERALES S.A.</option>
			<option value="AS11">LA PREVISORA S.A. COMPAÑÍA DE SEGUROS</option>
			...
			<option value="AS15">COMPAÑIA ASEGURADORA DE FINANZAS S.A. CONFIANZA</option>
