...
<?php
	...
	// consulto la tabla de terceros juridocos buscando el documento del interventor y tomo el nombre en la variable interventor
		...
		if (!$juridicos) 
		{
				echo ("Error al seleccionar los elementos de la tabla juridicos, Inténtelo más tarde");
		}
		if ($juridicos) 
		{
		...
		if (!$natura) 
		{
			echo ("Error al seleccionar los elementos de la tabla naturales, Inténtelo más tarde");
		}
		if ($natura)
		{
		...
		if ($modalidad =="SAF1")
		{
			$modalidad2 = "SELECCIÓN ABREVIADA - MENOR CUANTÍA";
		}
		if ($modalidad =="SAF2")
		{
			$modalidad2 = "SELECCIÓN ABREVIADA - CARACTERÍSTICAS TÉCNICAS UNIFORMES";
		}		
		if ($modalidad =="SAF3")
		{
			$modalidad2 = "SELECCIÓN ABREVIADA - HASTA 10% DE LA MENOR CUANTÍA";
		}	
		if ($modalidad =="CDF4")
		{
		...
		if ($modalidad =="LPF5")
		{
			$modalidad2 = "LICITACIÓN PUBLICA";
		}	
		if ($modalidad =="CMF6")
		{
			$modalidad2 = "CONCURSO DE MÉRITOS - HASTA 10% DE LA MENOR CUANTÍA";
		}		
		
		if ($modalidad =="CMF7")
		{
			$modalidad2 = "CONCURSO DE MÉRITOS";
		}			
		if ($modalidad =="OPF8")
		{
...
echo '<script languaje="JavaScript">
	...
	// selecciono opciones de formulario según procedimiento seleccionado
...
<!-- Presento la información presupuestal del contrato -->
	...
	<td  class="Estilo4" colspan="3">
			<select name="aseguradora"  class="Estilo4">
				<?php 
					...
					$aseg = array("","ACE SEGUROS S.A","CHARTIS S.A","ASEGURADORA COLSEGUROS S.A.", "ASEGURADORA SOLIDARIA DE COLOMBIA LTDA. ENTIDAD COOPERATIVA","BBVA SEGUROS COLOMBIA S.A.","CONDOR S.A. COMPAÑÍA DE SEGUROS GENERALES","COMPAÑÍA MUNDIAL DE SEGUROS S.A","SEGUROS GENERALES SURAMERICANA S.A.","CHUBB DE COLOMBIA COMPAÑÍA DE SEGUROS S.A.","GENERALI COLOMBIA SEGUROS GENERALES S.A.","LA PREVISORA S.A. COMPAÑÍA DE SEGUROS","LIBERTY SEGUROS S.A.","SEGUROS ALFA S.A.","SEGUROS DEL ESTADO S.A.","COMPAÑIA ASEGURADORA DE FINANZAS S.A. CONFIANZA","OTRA");
					$i=0;
					for ($i=0;$i<=16;$i++)
					{
						if ($compa == 'AS'.$i)
...
BUEN MANEJO E INVERSIÓN DEL ANTICIPO	</td>
	<td  class="Titulofor" align="center">
