...
function mostrarVentana()
{
	...
	var x =screen.width;
    ventana.style.marginTop = "300px"; // Definimos su posición vertical. La ponemos fija para simplificar el código
    ventana.style.marginLeft = x-600;//((document.body.clientWidth-10) / 2) +  "px"; // Definimos su posición horizontal
...
<tr>
    ...
    <td colspan="2"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
		...
		<option value='CDF4' selected>CONTRATACION DIRECTA</option>
   		<option value='CMF6'>CONCURSO DE MÉRITOS</option>
