...
<td bgcolor='#DCE9E5' align='center'><b>8. Número Del Contrato</b></td>
<td bgcolor='#DCE9E5' align='center'><b>9. Modalidad De Selección</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>16. Cédula /nit Del Contratista</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>19. Fecha De Suscripción Del Contrato</b></td>
<td bgcolor='#DCE9E5' align='center'><b>20. Cédula/nit Del Interventor O Supervisor</b></td>
<td bgcolor='#DCE9E5' align='center'><b>21. Nombre Completo Del Interventor</b></td>
<td bgcolor='#DCE9E5' align='center'><b>22. Tipo De Vinculación Interventor O Supervisor</b></td>
<td bgcolor='#DCE9E5' align='center'><b>23. Plazo De Ejecución- Unidad De Ejecución</b></td>
<td bgcolor='#DCE9E5' align='center'><b>24. Plazo De Ejecución- Número De Unidades</b></td>
<td bgcolor='#DCE9E5' align='center'><b>25. ¿se Pactó Anticipo Al Contrato?</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>29. Fecha De Terminación Del Contrato</b></td>
<td bgcolor='#DCE9E5' align='center'><b>30. Se Público En El Secop</b></td>
<td bgcolor='#DCE9E5' align='center'><b>31. Número Del Acto Que La Decreta La Urgencia Manifiesta</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>34. Valor Recursos Regalías (En Pesos)</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>38. V F Autorizada Año Inicia</b></td>
<td bgcolor='#DCE9E5' align='center'><b>39. V F Autorizada Año Final</b></td>
...
<td bgcolor='#DCE9E5' align='center'><b>46. Fecha De Suscripción Del Acta De Liquidación</b></td>
<td bgcolor='#DCE9E5' align='center'><b>47. Se Actualizó En El Secop</b></td>
...
while($rw = mysql_fetch_array($re))
{
			...
			if ($modalidad =='SA') {$mod ='SELECCIÓN ABREVIADA'; }  
			if ($modalidad =='CD') {$mod ='CONTRATACIÓN DIRECTA'; } 
			if ($modalidad =='LP') {$mod ='LICITACIÓN PÚBLICA'; } 
			if ($modalidad =='CM') {$mod ='CONCURSO DE MÉRITOS'; } 
			if ($modalidad =='OP') {$mod ='OTRO PROCEDIMIENTO'; } 
			if ($modalidad =='') {$mod =''; } 
			// Tipo de pago
			if ($rw9["opc1"] =='FUNCIONAMIENTO') {$tipo_pago ='FUNCIONAMIENTO';}
			if ($rw9["opc1"] =='INVERSION') {$tipo_pago ='INVERSIÓN';}
