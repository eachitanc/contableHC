...
while($rw = mysql_fetch_array($re)) 
{
	...
	$cod_rtefte= $rw["retefuente"];
		if ($retefuente >0) // unicamente consulto el codigo dian cuando se aplico retención
		{
...
while($rw = mysql_fetch_array($re)) 
{
	...
	$cod_rtefte= $rw["reteiva"];
		if ($reteiva>0) // unicamente consulto el codigo dian cuando se aplico retención
		{
...
// consulta y llenado de pagos sin afectación presupuestal
