...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td colspan="3">
		...
		<table width="800" border="0" align="center">
	<tr>
	  <td>	    <div align="center"><span class="Estilo4"><strong>MODIFICA  DATOS CUENTA DEL PRESUPUESTO DE INGRESOS </strong></span><br />
              <?php 
	  include('config.php');				
	  ...
	  <table width="750" border="1" align="center" class="bordepunteado1">
        ...
        <tr>
          ...
          <td width="375" bgcolor="#F5F5F5" class="Estilo4">
		   ...
		   $a=$_GET['id'];  
		   $a1=mysql_query("select * from car_ppto_ing where cod_pptal = '$a' and id_emp ='$idxxx'");  
