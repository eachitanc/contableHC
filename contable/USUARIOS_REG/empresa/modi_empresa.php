  ...
  <tr>
	...
	<table width="790"  border ='1' class='bordepunteado1' >
      ...
      <tr>
        ...
        <td class="Estilo4">
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <input name="nit" type="text" class="Estilo7" id="nit" tabindex="0" size="15" onkeypress="return validar(event)" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select nit from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%d", $row["nit"]); }  ?>" /> 
		  <span class="Estilo8">..</span> DV
          <input name="dv" type="text" class="Estilo4" id="dv" size="4" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select dv from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%d", $row["dv"]); }  ?>" />
		0 - 9 </div>		</td>
      </tr>
      <tr>
        <td class="Estilo4">
      ...
      <tr>
        ...
        <td class="Estilo4">
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <input name="tel" type="text" class="Estilo7" id="tel" tabindex="0" size="15" onkeypress="return validar(event)" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tel from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tel"]); }  ?>"/>
</div>		</td>
      </tr>
      <tr>
        <td class="Estilo4">
        ...
        <td class="Estilo4">
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <input name="fax" type="text" class="Estilo7" id="fax" tabindex="0" size="15" onkeypress="return validar(event)" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select fax from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["fax"]); }  ?>" />
</div>		</td>
      </tr>
      <tr>
        <td class="Estilo4">
        ...
        <td class="Estilo4">
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <input name="email" type="text" class="Estilo7" id="email" tabindex="0" size="40" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select email from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["email"]); }  ?>"/>
</div>		</td>
      </tr>
      <tr>
        <td class="Estilo4">
        ...
        <td class="Estilo4">
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <input name="web_site" type="text" class="Estilo7" id="web_site" tabindex="0" size="40" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select web_site from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["web_site"]); }  ?>"/>
</div>		</td>
      </tr>
	  <tr>
        <td class="Estilo4">
		  ...
		  <table width="820" border="0">
            ...
            <tr>
              ...
              <td><div id="div27" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="center">
                  <input name="ced_rep_leg" type="text" class="Estilo4" id="ced_rep_leg" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select ced_rep_leg from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["ced_rep_leg"]); }  ?>" />
                </div>
              </div></td>
              <td><div id="div16" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                
                  <div align="center">
                    <input name="tp_rep_leg" type="text" class="Estilo4" id="tp_rep_leg" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tp_rep_leg from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tp_rep_leg"]); }  ?>"/>
                    </div>
              </div></td>
            ...
            <tr>
              ...
              <td><div id="div26" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="center">
                  <input name="ced_cont" type="text" class="Estilo4" id="ced_cont" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select ced_cont from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["ced_cont"]); }  ?>"/>
                </div>
              </div></td>
              <td><div id="div17" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                
                  <div align="center">
                    <input name="tp_cont" type="text" class="Estilo4" id="tp_cont" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tp_cont from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tp_cont"]); }  ?>"/>
                    </div>
              </div></td>
            ...
            <tr>
              ...
              <td><div id="div25" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="center">
                  <input name="ced_rev_fis" type="text" class="Estilo4" id="ced_rev_fis" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select ced_rev_fis from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["ced_rev_fis"]); }  ?>"/>
                </div>
              </div></td>
              <td><div id="div18" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                
                  <div align="center">
                    <input name="tp_rev_fis" type="text" class="Estilo4" id="tp_rev_fis" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tp_rev_fis from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tp_rev_fis"]); }  ?>" />
                    </div>
              </div></td>
            ...
            <tr>
              ...
              <td><div id="div19" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                  ...
                  <div align="center">
                    <input name="tp_ctrl_int" type="text" class="Estilo4" id="tp_ctrl_int" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tp_ctrl_int from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tp_ctrl_int"]); }  ?>"/>
                    </div>
              </div></td>
            ...
            <tr>
                ...
                <div align="right">TESORERO :</div>
                  ...
                  <td  valign="middle"><div id="div22" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                      ...
                      <div align="center">
                        <input name="tp_otr_resp" type="text" class="Estilo4" id="tp_otr_resp" onkeypress="return validar(event)" size="16" value="<?php  mysql_connect($server,$dbuser,$dbpass); mysql_select_db($database);  $a=$_GET['id1'];  $a1=mysql_query("select tp_otr_resp from empresa where cod_emp = $a");  $result = @mysql_query($a1); while($row = mysql_fetch_array($a1)) { printf("%s", $row["tp_otr_resp"]); }  ?>"/>
                        </div>
                  </div></td>
