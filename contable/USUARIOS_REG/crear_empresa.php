...
?>
  ...
  <tr>
	...
	<table width="590"  border ='1' class='bordepunteado1' >
      ...
      <tr>
        <td colspan="2" bgcolor="#DCE9E5" class="Estilo4"><div id="div31" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
      ...
      <tr>
		...
		<div id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
		  <table width="580" border="0">
            <tr>
              <td width="154"><div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                </div></td>
              <td width="194"><div class="Estilo9" id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="center">NOMBRES COMPLETOS  </div>
              </div></td>
              <td width="109"><div class="Estilo10" id="div28" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="center">No. CEDULA  </div>
              </div></td>
              <td width="107"><div class="Estilo11" id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
            ...
            <tr>
              <td colspan="4"><table width="576" border="0" align="center">
                              <tr>
                                <td width="156" valign="middle"><div class="Estilo12" id="div9" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                                  <div align="center">OTROS RESPONSABLES  </div>
                                </div></td>
                                <td width="202" valign="middle"><div class="Estilo13" id="div29" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                                  <div align="center">NOMBRES COMPLETOS </div>
                                </div></td>
                  <td width="100" valign="middle"><div align="center"><strong>No. CEDULA </strong></div></td>
                  <td width="100" valign="middle"><div class="Estilo14" id="div22" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                    <div align="center">No.T.P.</div>
                  </div></td>
                </tr>
			    <tr>
                  ...
                  <td width="202" valign="middle"><div id="div15" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                  ...
                  <td width="100" valign="middle"><div id="div21" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
                    
                      <div align="center">
                        <input name="ced_otr_resp" type="text" class="Estilo4" id="ced_otr_resp" onkeypress="return validar(event)" size="20"/>
                      </div>
                  </div></td>
                  <td width="100" valign="middle"><div id="div22" style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:3px;">
...
?></td>
            ...
            <tr>
              <td colspan="4"><div class="Estilo4" id="div30" style="padding-left:0px; padding-top:15px; padding-right:0px; padding-bottom:15px;">
                <div align="center">
            ...
            <tr>
              <td colspan="4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
