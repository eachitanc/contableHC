...
if($naturaleza == 'DEBITO')
{
		...
		if($tip_dato == 'D')  
		{
			...
			$cxy = mysql_connect($server, $dbuser, $dbpass) or die ("Fallo en la Conexion a la Base de Datos");
...
/*$cxt = mysql_connect($server, $dbuser, $dbpass) or die ("Fallo en la Conexion a la Base de Datos");
