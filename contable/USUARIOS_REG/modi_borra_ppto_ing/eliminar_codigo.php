      ...
      <tr>
        <td colspan="2" bgcolor="#DCE9E5" class="Estilo4"><div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
          <div align="center"><strong>ELIMINAR CUENTA DEL PRESUPUESTO DE INGRESOS </strong><br />
              <br />
               <strong>Descripcion</strong>: Este proceso consiste en ELIMINAR una cuenta existente, sea MAYOR o DETALLE, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga  del Presupuesto de Ingresos</strong> o eliminar la cuenta definitivamente.          </div>
        </div></td>
        </tr>
      <tr>
...
Si elimina una cuenta creada en la CARGA INICIAL DEL PRESUPUESTO y decide crearla nuevamente en una fecha diferente a la de INICIO DE OPERACIONES, el valor por defecto de la misma pasara a ser cero (0) 
          ...
          <span class="Estilo8">VERIFIQUE LA FECHA EN LA QUE REALIZARA ESTE ELIMINACION </span>          </div>
        </div></td>
        </tr>
      <tr>
...
?>
  ...
  <tr>
	...
	<div align="center">
	<a href="../consulta_ppto_ing.php" target="_parent">VOLVER</a>	</div>
	</div>
	</div>	</td>
    <td>&nbsp;</td>
  </tr>
