...
$sa = "select * from cartera_cont where id_emp = '$id_emp' and recaudado = 'NO'";
	...
	if ($fecha2 == "AÑO"){$f= "and fecha_causa <= '$a2'";}
	$gby = "";
...
$sa = "select * from cartera_cont where id_emp = '$id_emp' and recaudado = 'SI'";
	...
	if ($fecha2 == "MES"){$f= "and fecha_causa between '$f1' and '$f2'";}
	if ($fecha2 == "DIA"){$f= "and fecha_causa ='$fechafil'";}
	if ($fecha2 == "AÑO"){$f= "and fecha_causa between '$a1' and '$a2'";}
	$gby = "";
	$orden = "order by fecha_causa desc";
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  </strong> <span class="Estilo8">&quot;EN <? echo $mesh[$me+0]." DE ".$an; ?>&quot; </span></div>
</div>
<br />
<?
$cx = mysql_connect($server, $dbuser, $dbpass) or die ("Fallo en la Conexion a la Base de Datos");
...
$sa = "select distinct(id_recau) , fecha_recaudo , id_reip , id_caic, tercero, id_manu_roit,vr_digitado  from recaudo_roit where id_emp = '$id_emp' and id_recau LIKE 'ROIT%'";
	if (empty($tercero)){$c = "";}else{$c= "and tercero =$tercero2";}
	if ($fecha2 == "MES"){$f= "and fecha_recaudo between '$f1' and '$f2'";}
	if ($fecha2 == "DIA"){$f= "and fecha_recaudo ='$fechafil'";}
	if ($fecha2 == "AÑO"){$f= "and fecha_recaudo between '$a1' and '$a2'";}
	$gby = "";
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  </strong> <span class="Estilo8">&quot;EN <? echo $mesh[$me+0]." DE ".$an; ?>&quot; </span>
  <br /><br />
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recaudos_sh/recaudar1.php" target="_parent">...::: CREAR NUEVA NOTA CREDITO BANCARIA :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../transferencia_nacion/recaudar1.php" target="_parent">...::: CREAR NUEVA TRANSFERENCIA :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_caja/recaudar1.php" target="_parent">...::: CREAR NUEVO RECIBO DE CAJA GENERAL :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_predial/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_urban/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_rtic/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_ica/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_ica1/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_ica2/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_ica3/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
...
<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
  ...
  <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="../recibo_rever/recaudar1.php?nom=<?php echo $rw4['nombre']; ?>" target="_parent">...::: NUEVO <?php echo $rw4['nombre']; ?> :::...  </a>  </div>
  </div>
  </div>
</div>
<br />
