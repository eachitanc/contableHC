...
$re2 = mysql_db_query($database, $sq, $cx);
...
";
$re2 = mysql_db_query($database, $sq, $cx) or die ($resultadoxx2 .mysql_error()."");
...
while($rw2 = mysql_fetch_array($re2)) 
{
	...
	$ref=$rw2["ref"];
		...
		while($rw2a = mysql_fetch_array($re2)) 
		{
			printf("
			<span class='Estilo4'>
			<tr>
...
while($rw2 = mysql_fetch_array($re)) 
{
...
<br />
  ...
  <tr>
    <td colspan="3"><div style="padding-left:5px; padding-top:20px; padding-right:5px; padding-bottom:10px;">
      <div align="center">
