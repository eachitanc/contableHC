...
$a = "select * from obcg where id_emp = '$id_emp' and pagado ='NO'";
	...
	if ($fecha2 == "AÑO"){$f= "and fecha_obcg between '$a1' and '$a2'";}
	$gby = "";
...
$a = "select distinct(id_auto_cobp), id_manu_cobp,  id_manu_crpp, id_manu_cdpp, fecha_cobp, tercero, contab, pagado from cobp where id_emp = '$id_emp' and contab ='NO' and pagado ='NO' and tesoreria = 'SI'";
	...
	if ($fecha2 == "AÑO"){$f= "and fecha_cobp between '$a1' and '$a2'";}
	$gby = "";
	$orden = "order by id asc";
...
$tot_cheques="";
if(trim($rw2r["num_cheque"]) != ""){$tot_cheques = $tot_cheques.trim($rw2r["num_cheque"]);}
if(trim($rw2r["num_cheque2"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque2"]);}
if(trim($rw2r["num_cheque3"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque3"]);}
if(trim($rw2r["num_cheque4"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque4"]);}
if(trim($rw2r["num_cheque5"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque5"]);}
if(trim($rw2r["num_cheque6"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque6"]);}
if(trim($rw2r["num_cheque7"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque7"]);}
if(trim($rw2r["num_cheque8"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque8"]);}
if(trim($rw2r["num_cheque9"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque9"]);}
if(trim($rw2r["num_cheque10"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque10"]);}
if(trim($rw2r["num_cheque11"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque11"]);}
if(trim($rw2r["num_cheque12"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque12"]);}
if(trim($rw2r["num_cheque13"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque13"]);}
if(trim($rw2r["num_cheque14"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque14"]);}
if(trim($rw2r["num_cheque15"]) != ""){$tot_cheques = $tot_cheques."&nbsp;".trim($rw2r["num_cheque15"]);}
