...
?>CREAR      
  ...
  <tr>
	  ...
	  <form name="a" method="post" onsubmit="return confirm('Verifique que todos los datos estan correctos')" action="p_new_concepto.php">
        <table align="center" width="800" border="1" class="bordepunteado1">
          ...
          <tr>
            ...
            <td width="310"><div align="left" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
		  ...
		  ?>
		<!-- Moastrar codigo de retención de acuerdo a la opcion recibida retención o iva, no se muestra para estampilla-->
		
		
		  <tr style="display:<? echo ($mostrar); ?> " >
            <td><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"><strong>CODIGO RETENCIONES PRACTICADAS </strong></div></td>
            <td ><div align="left" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
    ...
    <tr>
      <td colspan="3" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
    ...
    <tr>
      <td width="266" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4"><strong>BASE</strong></div>
      </div></td>
      
      <td width="267" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4"><strong>TOPE</strong></div>
      </div></td>
      <td width="263" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
    ...
    <tr>
      <td colspan="3" bgcolor="#990000"><div class="Estilo12 Estilo8" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="right" class="Estilo4">
            <div align="center"><strong><font color="#FFFFFF"> VERIFIQUE TODOS LOS DATOS ESAN CORRECTOS ANTES DE GRABAR</font></strong></div>
          </div>
      </div>        <div class="Estilo8" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
    ...
    <tr>
      ...
      <td colspan="3"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
