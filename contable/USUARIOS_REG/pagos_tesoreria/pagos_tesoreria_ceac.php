...
?>
      ...
      <td width="190"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;"></div></td>
    </tr>
  </table>
</form>
...
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
  <a href="nuevo_ceac.php" target="_parent">...::: CREAR NUEVO CEVA ACUMULADO:::...  </a>  </div>
  </div>
  <br />
<br />
...
$a = "select * from ceva where id_emp='$id_emp' and id_auto_cobp ='AUTO'";
	...
	if ($fecha2 == "MES"){$f= "and fecha_ceva between '$f1' and '$f2'";}
	if ($fecha2 == "DIA"){$f= "and fecha_ceva ='$fechafil'";}
	if ($fecha2 == "AÑO"){$f= "and fecha_ceva between '$a1' and '$a2'";}
