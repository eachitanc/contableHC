	...
	{																	
		req1.onreadystatechange = function() 
		{
			if (req1.readyState == 4 ) 
			{
				...
				if (dato > 0)
				{
				alert ("El número de cheque ya fue utilizado..");
...
//alert(existe);
	...
	{	
		...
		{
			alert("El número de comprobante ya fue utilizado...");
			existe=1;
...
?>
              ...
              </div><div id="juridicos" style="padding-left:5px; padding-top:0px; padding-right:5px; padding-bottom:0px; <?php echo $veaterjur; ?>">
                  <div align="left">
        ...
        <a href="javascript:mostrarVentana();">Mas</a>
               <div id="miVentana" style="position: fixed; width: 210px; height: 340px; top: 0; left: 0; font-family:Verdana,
                    ...
                    <div style="font-weight: bold; text-align: center; color: #FFFFFF; padding: 5px; background-color:#006394">
                      ...
                      <iframe id="datamain" src="cevaconsecutivo.php"  width="200" height="290" marginwidth="0" 
