...
while($rowxx4 = mysql_fetch_array($resultadoxx4)) 
{
 ...
 <input name="p1" id="p1" type="hidden" value="<? printf("%s",$p1);?>" /> 
  <input name="p2" id="p2" type="hidden" value="<? printf("%s",$p2);?>" />
   ...
   <input name="fecha_ceva123" id="fecha_ceva123" type="hidden" value="<? printf("%s",$fecha_ceva_e);?>" />  
   <input name="d_ceva" id="d_ceva" type="hidden" value="<? printf("%s",$des_ceva_e);?>" />  
   <input name="nceva" id="nceva" type="hidden" value="<? printf("%s",$ceva);?>" />
	...
	<table width="800" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo4"><? printf("%s",$crpp_m);?>
	  ...
	  <tr>
	    ...
	    <td width="200" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo4"><? printf("%s",$cobp_e);?>
              <input name="id_manu_cobp"  type="hidden" value="<? printf("%s",$cobp_e);?>" />
              <input name="id_auto_cobp" type="hidden" id="id_auto_cobp" value="<? printf("%s",$cobp_auto_e);?>" />
          </div>
	      </div></td>
	    <td width="200" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo12">
...
//--------	
  ...
  <table width="800" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="left">
          <input name="fecha_ceva" type="text" class="Estilo12"  id="fecha_ceva" value="<?  echo date('Y/m/d'); ?> " size="12"/>
      ...
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo12">
            <div align="center">
			  ...
			  value="<? printf("%s",$subceva); ?>" onkeyup="chk_ceva();" />
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
        <div align="center" class="Estilo20">
          <input name="des_ceva" type="text"  readonly="readonly" id="des_ceva" onblur="this.value=this.value.toUpperCase();" value="<? echo $des_ceva_e; ?>" style="width:500px;" />
        </div>
      </div></td>
      </tr>
      ...
      <td colspan="4" bgcolor="#66CCCC"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="center" class="Estilo12">
          <div align="center"><strong>Si el pago a realizar no tiene IVA, deje la casilla en BLANCO,<br />
            ...
            <input name="iva" size="5" type="text" class="Estilo12" id="iva" style="text-align:center" onkeyup="cinco();" onkeypress="return validar(event)" value="<?  printf("%s",$iva_e); ?>" readonly="readonly"  />
  ...
  <table width="800" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="salud" type="text" class="Estilo12" id="salud" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$salud_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly" />
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="pension" type="text" class="Estilo12" id="pension" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$pension_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="libranza" type="text" class="Estilo12" id="libranza" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$libranza_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="f_solidaridad" type="text" class="Estilo12" id="f_solidaridad" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$solidaridad_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="f_empleados" type="text" class="Estilo12" id="f_empleados" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$empleados_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="sindicato" type="text" class="Estilo12" id="sindicato" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$sindicato_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="embargo" type="text" class="Estilo12" id="embargo" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$embargo_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center"><input name="cruce" type="text" class="Estilo12" id="cruce" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$cruce_e);?>" onkeyup="tres();"  onChange="ceros();" readonly="readonly"/></div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="otros" type="text" class="Estilo12" id="otros" style="text-align:right" onkeypress="return validar(event)" value="<? printf("%s",$otros_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td>&nbsp;</td>
