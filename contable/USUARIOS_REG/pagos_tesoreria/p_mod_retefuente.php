...
$cuenta=$_POST['cuenta'];
$codigo=$_POST['codigo'];
// consulto cual es el nombre de la estampilla antes de realizar la modificación
...
$sql = "update retefuente set concepto='$concepto',a_partir='$a_partir',tarifa='$tarifa', cuenta ='$cuenta', codigo_ret='$codigo' where id = '$id' ";
