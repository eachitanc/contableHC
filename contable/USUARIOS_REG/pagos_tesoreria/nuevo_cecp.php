      ...
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
		  ...
		  <?
			...
			?>
            <input name="fecha_cecpp" type="text" class="required Estilo12"  id="fecha_cecpp" value="<? printf($fecha_cecp);?>" size="12" />
            ...
            <div align="center" class="Estilo12">
			  ...
			  <?
				...
				if ($ultimo2 =='')
				{
					...
					$re5= mysql_query("select distinct id_manu_cecp FROM cecp");
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="left" class="Estilo4">
            <input name="concepto_pago" type="text" class="required Estilo4" id="concepto_pago" onkeyup="a.concepto_pago.value=a.concepto_pago.value.toUpperCase();" style="width: 520px;" value="<? $conce=$_POST['concepto_pago']; printf("%s",$conce); ?>"/>
          </div>
        </div></td>
        </tr>
      <tr>
