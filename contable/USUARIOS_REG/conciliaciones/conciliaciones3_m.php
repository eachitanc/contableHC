...
<style type="text/css">
<!--
input {font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 10px; color: #333333; }
...
function conciAnterior(id,archivo,div)
{
	...
	for (i=1;i<6;i++)
	{
		...
		var cual = document.getElementById(control);
			...
			if (cual.checked)
			{
				if (i == 1) {document.getElementById('fecha').select();}
				if (i == 2) {document.getElementById('comp').select();}
				if (i == 3) {document.getElementById('cheque').select();}
				if (i == 4) {document.getElementById('deb').select();}
				if (i == 5) {document.getElementById('cre').select();}
			}
		}
      ...
      <div align="center">
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
             <div align="center"><a href='aa1.php?mes=<?php  echo $fecha_fin; ?>&cuenta=<? echo $cuenta; ?>' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
      </div>
    </div></td>
...
while($rw = mysql_fetch_array($re)) {$saldo_extracto=$rw["saldo_extracto"];$nom_rubro=$rw['nom_rubro'];}//printf(" nom_rubro : $nom_rubro<br>");
