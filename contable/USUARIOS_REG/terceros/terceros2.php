	...
	<form name="a" method="post" action="proc_naturales.php" onsubmit="return confirm('Verifique su Informacion antes de Grabar')">
	  <table width="750" border="1" align="center" class="bordepunteado1">
       ...
       <tr>
          ...
          <td class="Estilo4"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>Valor <input name="monto" type="text" class="Estilo4" id="monto" style="width:100px;text-align:right" /></div> </td>
        </tr> 
