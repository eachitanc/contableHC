...
<table width="800" border="0" align="center">
  ...
  <tr>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
      <tr>
        <td colspan="3" bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center">
<?php 
...
<? 
		   ...
		   $a=$_GET['id'];  
		   $a1=mysql_query("select * from car_ppto_ing where cod_pptal = '$cod_pptal' and id_emp ='$idxx'");  
...
?>
      ...
      <tr>
        <td width="225" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center">CODIGO PRESUPUESTAL</div>
        </div></td>
        <td width="507" colspan="2" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="left">
      ...
      <tr>
        ...
        <td colspan="2" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="left">
			<?php printf("%s", $c3); ?>
	...
	<BR />
<?php 
$c1 = mysql_connect($server, $dbuser, $dbpass) or die ("Fallo en la Conexion a la Base de Datos");
$s1 = "select * from empresa where cod_emp = '$idxx' ";
$r1 = mysql_db_query($database, $s1, $c1);
...
<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td colspan="3" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center"><strong>FORMATO UNICO TERRITORIAL DE INGRESOS<br />
            - F.U.T - </strong></div>
        </div></td>
      </tr>
      <tr>
        <td colspan="3" class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="left"><strong>CODIGO              - F.U.T - </strong></div>
        </div></td>
      </tr>
      <tr>
        <td colspan="3" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
<? 
 ...
 ?>
      ...
      <tr>
       <td width="223" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo12" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
         <div align="center">LIBRE (LD) - CONDICIONADO (DE)  </div>
       </div></td>
        <td width="257" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        ...
        <td width="246" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center"><b class="Estilo4">ACTUALMENTE</b> : <span class="Estilo4"><br /><?php printf("%s", $c5); ?></span></div>
        </div></td>
      </tr>
      <tr>
        <td width="223" class="Estilo4"><div class="Estilo13" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center">ACTO ADMINISTRATIVO DE LIBRE A CONDICIONADO  </div>
        </div></td>
        <td width="257"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
       <td width="223" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo14" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
       <td width="223" class="Estilo4"><div class="Estilo15" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
         <div align="center">PORCENTAJE </div>
       </div></td>
        <td width="257"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
         
		  <input name="porcentaje_fut" type="text" class="Estilo4" id="porcentaje_fut" size="20" maxlength="100" 
		  onkeypress="return validar(event)"
		  onblur = "javascript:if(parseInt(this.value,10) > 100) 
		  {alert('El valor ha de ser un número inferior a 100\n\nSiga bajo su propio Riesgo'); return false;}" />
          
		  <span class="Estilo4"><strong>%</strong></span></div></td>
        <td width="246"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
       <td width="223" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo16" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
         <div align="center">VALOR </div>
       </div></td>
        <td width="257" bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center">sera calculado al procesar el formulario </div>
        </div></td>
...
?>	
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
 ...
 ?>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
	  <tr class="bordepunteado1">
        <td width="736"><div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
            <div align="center">
