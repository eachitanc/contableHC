...
?>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td align="left"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> <span class="Estilo4"> 1. Si desea <strong>MODIFICAR</strong> una <strong>ADICION</strong>, eliminela y creela nuevamente con los datos correctos.
          <br />
        </span> </div></td>
      </tr>
    </table>
