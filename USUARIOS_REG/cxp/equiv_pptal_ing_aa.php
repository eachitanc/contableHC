...
?>
            ...
            <strong>DEFINIR HOMOLOGACION PRESUPUESTAL PARA CUENTAS POR PAGAR </strong> </div>
        </div></td>
      </tr>
      <tr>
        <td colspan="3" bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
        <td width="300" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center">CODIGO PRESUPUESTAL</div>
        </div></td>
        <td width="432" colspan="2"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="left">
...
?>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
	  ...
	  <tr class="bordepunteado1">
	    <td><div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
