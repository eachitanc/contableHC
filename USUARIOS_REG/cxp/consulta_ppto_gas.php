...
</span> <span class="Estilo9">:</span>constantemente				    </span>			</div>			</td>
          </tr>
        </table>
	   <BR />
...
while($rw = mysql_fetch_array($re)) 
   {
$cod =$rw["cod_pptal"];
$res2=mysql_db_query($database,"select sum(ppto_aprob) as def from cxp where cod_pptal like '$cod%' and tip_dato='D'",$cx);
...
</tr>", $rw["cod_pptal"], $rw["ano"], $rw["cod_pptal"], $rw["cod_pptal"], 
