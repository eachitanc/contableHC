      ...
      <tr>
		...
		<div id="div7" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
          	  <div align="center"><strong>MODIFICAR CUENTA POR PAGAR </strong><br />
          	    <br />
          	    <strong>Descripcion</strong>: Este proceso consiste en CAMBIAR una cuenta  DETALLE a MAYOR, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga  de las Cuentas por Pagar </strong></div>
		</div></td>
        </tr>
      <tr>
