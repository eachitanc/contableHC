...
<table width="800" border="0" align="center">
  ...
  <tr>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
       <td width="250"><div id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
         <div align="center"><span class="Estilo4"><strong>PASO 1. </strong><br />
           SELECCIONE la cuenta DETALLE  que desea CANCELAR </span><br />
         </div>
       </div></td>
        <td width="500" colspan="2"><div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
		  <?php 
include('../config.php');				
...
?>
	...
	<table width="750" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td align="left"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> <span class="Estilo4"> 1. Si desea <strong>MODIFICAR</strong> una <strong>CANCELACION</strong>, eliminela y creela nuevamente con los datos correctos.
          <br />
        </span> </div></td>
      </tr>
    </table>
...
</tr>", $rw["id"], $rw["fecha_adi"], $rw["cod_pptal"],
		$rw["nom_rubro"], $rw["valor_adi"]); 
