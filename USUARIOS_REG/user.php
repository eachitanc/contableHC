  ...
  <tr>
    <td colspan="3">
	  <table width="750" border="1" align="center" class="bordepunteado1">
        <tr>
          <td colspan="2" bgcolor="#DCE9E5"><div id="div2" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
...
?>
          ...
          (VERIFIQUE QUE LA FECHA DE SU COMPUTADORA ESTE CORRECTAMENTE CONFIGURADA)</span></div>
		  </div>		  </td>
          <td width="400">
		   <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
<table width="400" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
	...
	<div id="main_div" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
	   ...
	   <div align="center">
	     <input name="inicio" type="text" class="Estilo4" id="inicio" value="<?php $bb=date("Y/m/d"); printf($bb); ?>" size="12" />
...
while($row =$re3->fetch_assoc()) 
   {
   $fecha_s = $row["ano"];
  echo "<span class='Estilo4'><b>Fecha de Trabajo ACTUAL = %s </b></span><BR> ". $row["ano"];  
    $id=$row["id_emp"];
   }
...
<!-- <img src="imgages/publicidad.jpg" height="507" width="600" border="0">  -->
	...
	<table width="750" border="1" align="center" class="bordepunteado1" id="menu" style="display:block">
            ...
            <tr>
              <td valign="top" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                <div align="center"><b class="Estilo4">1. CONFIG DEL SISTEMA</b><br />
                </div>
              </div></td>
              <td valign="top" bgcolor="#DCE9E5" class="Estilo4"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
...
3.9. <a href="#" onmouseover="Tip('<br>3.7.1. <a href=\'pagos_tesoreria/cheques.php\'>Buscar cheques<\/a><br><br>3.7.2. <a href=\'informes_tesoreria/relacion_cheques_corte.php\'>Libro radicador cheques<\/a><br><br>3.7.3. <a href=\'informes_tesoreria/estampillas.php\'>Descuento de estampillas<\/a><br><br>3.7.4. <a href=\'informes_tesoreria/retefuente.php\'>Retenci&oacute;n en la fuente<\/a><br><br>3.7.5. <a href=\'informes_tesoreria/certifi.php\'>Certificado de retenciones<\/a><br><br>', WIDTH, 250, TITLE, '<center>Herramientas</center>', SHADOW, true, FADEIN, 300, FADEOUT, 300, STICKY, 1, CLOSEBTN, true, CLICKCLOSE, true)" onmouseout="UnTip()">Herramientas</a><br />
            ...
            <tr>
              <td valign="top" class="Estilo4"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;"> 4.1. <a href="mvto_contable/menu_cont.php" target="_parent">Movimientos</a><br />
 ...
 <script type="text/javascript" src="wz_tooltip/wz_tooltip.js"></script>
              ...
              <td valign="top" class="Estilo4"><div class="Estilo4" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
 ...
 <script type="text/javascript" src="wz_tooltip/wz_tooltip.js"></script>	  
			  5.9. <a href="#" onmouseover="Tip('&lt;br&gt;5.9.1. &lt;a href=\'informes_dian/index.php\'&gt;Informacion Exogena&lt;\/a&gt;&lt;br&gt;&lt;br&gt;5.9.2. &lt;a href=\'informes_dian/upload.php\'&gt;Acumular Formato 1001&lt;\/a&gt;&lt;br&gt;&lt;br&gt;5.9.3. &lt;a href=\'informes_tesoreria/certifi.php\'&gt;Certificado de ingresos&lt;\/a&gt;&lt;br&gt;&lt;br&gt;', WIDTH, 350, TITLE, '&lt;center&gt;Informes Dian&lt;/center&gt;', SHADOW, true, FADEIN, 300, FADEOUT, 300, STICKY, 1, CLOSEBTN, true, CLICKCLOSE, true)" onmouseout="UnTip()">Dian </a> </div></td>
             
			  <td valign="top"><div class="Estilo4" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;"> 6.1. <a href="nomina/menu_nomina.php" target="_parent">Talento Humano</a><br />
                6.2 Inventarios<br />
...
<div align="center">
<a href='logout.php' target='_parent'>SALIR DEL SISTEMA  </a></div>
</div>
</div>
</center>
