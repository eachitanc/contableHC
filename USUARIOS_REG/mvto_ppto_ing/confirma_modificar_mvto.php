...
</tr>", $rw["cuenta"], $rw["nom_rubro"], $rw["tercero"], $rw["valor"] , 

$rw["id"], $rw["cuenta"] , $rw["consecutivo"], 

$rw["id"] , $rw["cuenta"], $rw["consecutivo"], $rw["ter_nat"], $rw["ter_jur"], $rw["des"], $rw["valor"], $rw["nom_rubro"]
...
?>
  ...
  <tr>
    <td colspan="4" bgcolor="#F5F5F5"><div class="Estilo8" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
      <div align="center">
        <input name="Submit3222" type="submit" class="Estilo9"  value="A&ntilde;adir Imputacion Presupuestal" 
