...
$resulta=mysql_query("select SUM(valor) AS TOTAL from reip_ing WHERE id_emp ='$idxx' and cuenta ='$new_cuenta'",$link) or die (mysql_error());
...
else
{
	...
	$resultado1 = mysql_db_query($database, $sqlx1, $connectionxx);
	...
	$resultado2 = mysql_db_query($database, $sqlx2, $connectionxx);
	
	//actualizar el registro especifico
	$sqlx3 = "update reip_ing set valor='$new_valor' where id_emp= '$idxx' and id ='$id' ";
	$resultado3 = mysql_db_query($database, $sqlx3, $connectionxx);
