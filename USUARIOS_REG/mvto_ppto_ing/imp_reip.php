...
.Estilo22 {font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; color: #333333; font-weight: bold; }
-->
</style>
<script> 
function validar(e) { 
...
$resulta=mysql_query("select SUM(valor) AS TOTAL from reip_ing WHERE id_emp ='$id_emp' and consecutivo ='$id'",$link) or die (mysql_error());
...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
    <td width="170"><div align="center"><img src="../images/PLANTILLA PNG PARA LOGO EMPRESA.png" width="107" height="88"></div></td>
    <td width="475"><div style="padding-left:5px; padding-top:20px; padding-right:5px; padding-bottom:20px;">
