...
$dir=$rw["dir"];
if ($pendiente > 0 or $dir ==''){$fondo ="bgcolor='#ffff66'";}else{$fondo='';}
printf("
<span class='Estilo4'>
<tr>
...
</tr>", $rw["clase"], $rw["regimen"], $rw["ent_ofi"], 
		$nom_comp, $rw["mpio"], 
		$rw["id"], $rw["id"]); 
...
$dir2=$rw2["dir2"];
if ($pendiente2 > 0 or $dir2 ==''){$fondo2 ="bgcolor='#ffff66'";}else{$fondo2='';}
printf("
<span class='Estilo4'>
<tr>
<td align='center'><span class='Estilo4'> %s </span></td>
...
</tr>", $rw2["clase2"], $rw2["regimen2"], $rw2["ent_ofi2"], 
		$rw2["raz_soc2"], $rw2["mpio2"], 
		$rw2["id"], $rw2["id"]); 
   }
printf("</table></center>");
