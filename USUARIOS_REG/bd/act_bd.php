...
$resultado = mysql_query("SELECT * FROM actualizar ");
if ($resultado == '')
{
...
INSERT INTO `actualizar` VALUES ('1', 10);";
		mysql_select_db ($base, $conexion);
		if(mysql_query ($anadir78 ,$conexion)) 
		{
		echo "";
		}
		else
...
$rs10 = mysql_query($sq10,$conexion);
while ($rw10 = mysql_fetch_array($rs10))
{
	if ($rw10["tercero"]=="")
	{
		$sq11 ="select * from cobp where id_auto_cobp ='$rw10[id_auto_cobp]'";
		$rs11 = mysql_query($sq11);
		...
		mysql_query($sq12, $conexion) or die(mysql_error());
	}	
}
...
mysql_select_db ($base, $conexion);
		if(mysql_query ($anadir70 ,$conexion)) 
		{
		echo "";
		}
		else
...
mysql_select_db ($base, $conexion);
		if(mysql_query ($anadir71 ,$conexion)) 
		{
		echo "";
		}
		else
...
mysql_select_db ($base, $conexion);
		...
		if(mysql_query ($anadir56 ,$conexion)) 
		{
		echo "";
		}
		else
...
mysql_select_db ($base, $conexion);
		...
		if(mysql_query ($anadir2 ,$conexion)) 
		{
		echo "";
		}
		else
...
mysql_select_db ($base, $conexion);
		...
		if(mysql_query ($anadir3 ,$conexion)) 
		{
		echo "";
		}
		else
...
mysql_select_db ($base, $conexion);
		...
		if(mysql_query ($anadir4,$conexion)) 
		{
		echo "";
		}
		else
