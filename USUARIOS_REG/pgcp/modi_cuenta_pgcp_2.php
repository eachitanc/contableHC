...
.Estilo18 {font-weight: bold; color: #000000; }
</style>
...
while($rowxxx = $rxx->fetch_array())
  ...
  <tr>
    <td><form action="proc_modi_pgcp_2.php" method="post" name="empresa" id="empresa" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
      <table width="620" border="1" align="center" class="bordepunteado1">
        <tr>
          <td width="304" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
                <div align="right">CODIGO	CUENTA	SELECCIONADA </div>
              </div>
          </div></td>
          <td colspan="2" bgcolor="#F5F5F5" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        ...
        <tr>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="center" class="Estilo4">
        ...
        <tr>
          ...
          <td width="59" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
              <div align="right">
          ...
          <td width="237" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo9" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
              <div align="left"></div>
            </div>
          </div></td>
        ...
        <tr>
          <td colspan="3" bgcolor="#FFFFFF" class="Estilo4"><table width="612" border="0" align="center">
            <tr>
              <td width="169" bgcolor="#EBEBE4" class="Estilo4"><div class="Estilo17" id="div" style="padding-left:3px; padding-top:5px; padding-right:15px; padding-bottom:3px;">
                <div align="right"><strong>NOMBRE DE LA CUENTA: </strong></div>
              </div></td>
              <td width="433" colspan="2" bgcolor="#EBEBE4" class="Estilo4"><div id="div" style="padding-left:30px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                <div align="left">
            ...
            <tr>
              <td bgcolor="#EBEBE4" class="Estilo4"><div class="Estilo18" id="div" style="padding-left:3px; padding-top:5px; padding-right:15px; padding-bottom:3px;">
            ...
            <tr>
              <td colspan="3" class="Estilo4"><table width="587" border="0" align="center">
                <tr>
...
?>
        ...
        <tr>
          <td colspan="3"><div style="padding-left:5px; padding-top:20px; padding-right:5px; padding-bottom:5px;">
            <div align="center">
