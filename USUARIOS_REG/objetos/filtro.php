	...
	<td>
		...
		<? 
			if (empty($pendiente)){
					...
					?><input name="pendiente"  type="checkbox" value="1"  checked  style="display:<?php echo $ver_pendiente ?>"/><span class="sidebar3"><?php echo $nom_pendientes; ?></span><?
			} 
		
			if (empty($registrado)){
					?><input name="registrado" type="checkbox" value="1" /><span class="sidebar"><?php echo $nom_registrados; ?></span><?
			}else{
					?><input name="registrado" type="checkbox" value="1"  checked /><span class="sidebar3"><?php echo $nom_registrados; ?></span><?
			} 
		?>
