...
<body>
	...
	if(isset($_POST["nn"])) $_POST["nn"]=$_POST["nn"]; else  $_POST["nn"]='';
	if(isset($_GET["nn"])) $_GET["nn"]=$_GET["nn"]; else  $_GET["nn"] ='';
	if(isset($_POST["pendiente"])) $_SESSION["pendiente"] = $_POST["pendiente"]; else $_SESSION["pendiente"]='';
	if (isset($_POST["registrado"])) $_SESSION["registrado"] = $_POST["registrado"]; else $_SESSION["registrado"]='';
	$_POST["nn"] . $_GET["nn"];
	if ($document1 == "") {
