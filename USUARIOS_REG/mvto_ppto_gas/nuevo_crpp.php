...
function ocultarVentana()
{
	...
	$sql3 = mysql_db_query($database,"select * from cdpp where consecutivo ='$id'",$cx);
...
<table width="800" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:25px; padding-right:5px; padding-bottom:20px;">
      <div align="center">
