...
<span class="Estilo11">::</span>
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
        <div align="center">
            <input name="Submit321" type="submit" class="Estilo4"  value="CDP Abiertos" 
			onclick="this.form.action = 'cdpp_crpp.php'" />
            
            <input name="Submit322" type="submit" class="Estilo4"  value="Cuentas Por Pagar" 
			onclick="this.form.action = 'cxp.php'" />
			<!--    nuevo boton -->
			<input name="Submit323" type="submit" class="Estilo4"  value="Reservas" 
			onclick="this.form.action = 'reserva.php'" />
          </div>
      </div>
    </div></td>
  </tr>
