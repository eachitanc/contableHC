...
<tr>
    <td align="center" colspan="15"><font size="4"><b>P.A.C. DE INGRESOS</b></font></td>
</tr>
<tr>
...
//****
//****
	$resultax=mysql_query("select SUM(ppto_aprob) AS TOTAL from car_ppto_ing WHERE (ano between '$fecha_ini' and '$fecha_fin' )  and tip_dato ='D' and cod_pptal LIKE '$cod%'",$link) or die (mysql_error());
	$rowx=mysql_fetch_row($resultax);
	$inicial=$rowx[0];
	//****
	
	$resulta=mysql_query("select SUM(valor_adi) AS TOTAL from adi_ppto_ing WHERE (fecha_adi between '$fecha_ini' and '$fecha_fin' )  and cod_pptal LIKE '$cod%'",$link) or die (mysql_error());
	$row=mysql_fetch_row($resulta);
	$total_adi=$row[0]; 
	
	$resulta2=mysql_query("select SUM(valor_adi) AS TOTAL from red_ppto_ing WHERE (fecha_adi between '$fecha_ini' and '$fecha_fin' )  and cod_pptal LIKE '$cod%'",$link) or die (mysql_error());
	$row2=mysql_fetch_row($resulta2);
	$total_red=$row2[0];
	
	$resulta9=mysql_query("select SUM(valor_adi) AS TOTAL from contracreditos_ing WHERE (fecha_adi between '$fecha_ini' and '$fecha_fin' )  and cod_pptal LIKE '$cod%'",$link) or die (mysql_error());
	$row9=mysql_fetch_row($resulta9);
	$total_cotracred=$row9[0];
	
	$resulta8=mysql_query("select SUM(valor_adi) AS TOTAL from creditos_ing WHERE (fecha_adi between '$fecha_ini' and '$fecha_fin' )  and cod_pptal LIKE '$cod%'",$link) or die (mysql_error());
	$row8=mysql_fetch_row($resulta8);
	$total_cred=$row8[0];
	
	$definitivo = $inicial + $total_adi - $total_red + $total_cred - $total_cotracred;
//enero
$sqlceva = mysql_query("SELECT SUM(enero) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$enero=$row8[0];
// febrero
$sqlceva = mysql_query("SELECT SUM(febrero) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$febrero=$row8[0];
// marzo
$sqlceva = mysql_query("SELECT SUM(marzo) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$marzo=$row8[0];
// Abril 
$sqlceva = mysql_query("SELECT SUM(abril) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$abril=$row8[0];
// Mayo
$sqlceva = mysql_query("SELECT SUM(mayo) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$mayo=$row8[0];
// Junio
$sqlceva = mysql_query("SELECT SUM(junio) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$junio=$row8[0];
// Julio
$sqlceva = mysql_query("SELECT SUM(julio) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$julio=$row8[0];
// Agosto
$sqlceva = mysql_query("SELECT SUM(agosto) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$agosto=$row8[0];
// Septiembre
$sqlceva = mysql_query("SELECT SUM(septiembre) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$septiembre=$row8[0];
// octubre
$sqlceva = mysql_query("SELECT SUM(octubre) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$octubre=$row8[0];
// Noviembre
$sqlceva = mysql_query("SELECT SUM(noviembre) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
$noviembre=$row8[0];
// Diciembre
$sqlceva = mysql_query("SELECT SUM(diciembre) AS enero FROM pac_ingresos where  cod_pptal LIKE '$cod%' ",$link) or die (mysql_error());
$row8=mysql_fetch_row($sqlceva);
