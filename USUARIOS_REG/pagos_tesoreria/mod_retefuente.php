  ...
  <tr>
	...
	<? 
	 ...
	 echo "<tr aling='center' style='position:relative; display:$acc;' id='fil$i'>
	  ...
	  <td><a href='eliminar_rango.php?id=$id5[$j]&id1=$id&pag=mod_retefuente.php'><img src='../images/error.png' width='20' border='0' /></a></td>
    </tr>";
    if($i==$maxi){$acc='none';}}
    ?>
	...
	<tr>
      <td colspan="4" bgcolor="#990000"><div class="Estilo12 Estilo8" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="right" class="Estilo4">
            <div align="center"><strong><font color="#FFFFFF">VERIFIQUE TODOS LOS DATOS SEAN CORRECTOS ANTES DE GRABAR</font></strong></div>
          </div>
