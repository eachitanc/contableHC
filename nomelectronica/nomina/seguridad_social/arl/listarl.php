                ...
                <div class="container-fluid p-2">
                    <div class="card mb-4">
                        <div class="card-header" id="divTituloPag">
                            <div class="row">
                                <div class="col-md-11">
                                    <i class="fas fa-user-shield fa-lg" style="color:#1D80F7"></i>
                                    LISTA DE ADMINISTRADORAS DE RIESGOS LABORALES (ARL).
                                </div>
                                <?php if ((intval($permisos['registrar'])) === 1) { ?>
                                    <div class="col-md-1" title="Agregar">
                                        <a type="button" class="btn btn-success btn-sm btn-circle-plus float-right" href="<?php echo $_SESSION['urlin'] ?>/nomina/seguridad_social/arl/registrar/formaddarl.php">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered table-sm" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php foreach ($obj as $o) { ?>
                                            <tr id="filaempl">
                                                <td><?php echo mb_strtoupper($o['nombre_arl']) ?></td>
                                                <td><?php echo $o['nit_arl'] . '-' . $o['dig_ver'] ?></td>
                                                    ...
                                                    <div class="center-block">
                                                        <div class="input-group">
                                                            <?php if ((intval($permisos['editar'])) === 1) { ?>
                                                                <form action="<?php echo $_SESSION['urlin'] ?>/nomina/seguridad_social/arl/actualizar/formuparl.php" method="POST">
                                                                    <input type="text" name="idUpArl" value="<?php echo $o['id_arl'] ?>" hidden="true">
                                                            ...
                                                            ?>
                                                                <div class="col-md-3" id="divDelArl">
                                                                    <button class="btn btn-outline-danger btn-sm btn-circle" value="<?php echo $o['id_arl'] ?>" title="Eliminar">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm" id="btnConfirDelArl">Aceptar</button>
