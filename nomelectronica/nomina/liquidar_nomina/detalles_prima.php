...
try {
    ...
    $sql = "SELECT seg_empleado.id_empleado, no_documento, CONCAT(nombre1, ' ',nombre2, ' ',apellido1, ' ', apellido2) AS nombre, cant_dias, val_liq_ps
            FROM
                seg_liq_prima
                        ...
                        <div class="card-header" id="divTituloPag">
                            <div class="row">
                                <div class="col-md-11">
                                    ...
                                    LISTA DE EMPLEADOS PRIMA LIQUIDADA PERIODO <?php echo $periodo ?>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($obj as $o) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo pesos($o['val_liq_ps']) ?></td>
                                            </tr>
                                        <?php }
                                        ?>
                                    </tbody>
