...
$idviat = $_POST['numIdUpViat'];
$idmes = $_POST['numIdMesUpViat'];
$idemupviat = $_POST['numIdUpEmplViatic'];
try {
    $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
    $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
    $sql = "SELECT id_detviatic, seg_viaticos.id_viaticos AS id_viat, desc_general, concepto, valor, fviatico
            FROM
                seg_viaticos 
            INNER JOIN seg_detalle_viaticos
                ON (seg_detalle_viaticos.id_viaticos = seg_viaticos.id_viaticos)
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body" id="divCuerpoPag">
                            <form id="formUpViat">
                                ...
                                <a type="button" class="btn btn-danger btn-sm" href="../listviaticos.php">Cancelar</a>
