...
try {
    ...
    $sql = "SELECT CONCAT(nombre1, ' ', nombre2, ' ',apellido1, ' ', apellido2) AS nomcomp, no_documento, id_he_trab,desc_he,cantidad_he, fec_inicio, fec_fin, hora_inicio, hora_fin
            ...
            WHERE  seg_empleado.id_empleado = '$idemphex' AND fec_inicio BETWEEN '$fec_i' AND '$fec_f'";
    $rs = $cmd->query($sql);
    $obj = $rs->fetchAll();
    $cmd = null;
                                                ...
                                                <td>
                                                    <div class="center-block">
                                                        <div class="input-group">
                                                            ...
                                                            ?>
                                                                <form action="formuphoex.php" method="POST">
                                                                    <input type="number" name="idUpHoexs" value="<?php echo $o['id_he_trab'] ?>" hidden="true">
                                                                    <input type="text" value="<?php echo $mes ?>" name="valmesreghe" hidden="true">
                                                                    <input type="text" value="<?php echo $idemphex ?>" name="validreghe" hidden="true">
