...
try {
    ...
    $sql = "UPDATE seg_embargos SET id_juzgado = ?, tipo_embargo = ?, valor_total = ?, dcto_max = ?, valor_mes = ?, porcentaje = ?, fec_inicio = ?, fec_fin = ? WHERE id_embargo = ?";
    $sql = $cmd->prepare($sql);
