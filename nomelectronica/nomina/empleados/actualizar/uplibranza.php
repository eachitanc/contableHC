...
try {
    ...
    $sql = "UPDATE seg_libranzas SET id_banco = ?, valor_total = ?, cuotas = ?, descripcion_lib = ?, val_mes = ?, porcentaje = ?, fecha_inicio = ?, fecha_fin = ? WHERE id_libranza = ?";
    $sql = $cmd->prepare($sql);
