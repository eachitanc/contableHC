...
try {
    ...
    $sql = "INSERT INTO seg_embargos (id_juzgado, id_empleado,tipo_embargo, valor_total, dcto_max, valor_mes, porcentaje, fec_inicio, fec_fin, estado, fec_reg) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $sql = $cmd->prepare($sql);
