...
try {
    ...
    $sql = "INSERT INTO seg_libranzas (id_banco, id_empleado, valor_total, cuotas, descripcion_lib, val_mes, porcentaje, estado, fecha_inicio, fecha_fin, fec_reg) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $sql = $cmd->prepare($sql);
